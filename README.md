...
Foodgram - это веб-приложение для публикации рецептов. Пользователи могут создавать свои рецепты, добавлять чужие рецепты в избранное, подписываться на других авторов и формировать список покупок для выбранных блюд.
...
- Работа с изображениями профиля
...
- Gunicorn
- Развертывание: GitHub Actions (CI/CD)
...
```
git clone<git@github.com:ArtemYuvanov/foodgram.git>
cd foodgram/infra
```
